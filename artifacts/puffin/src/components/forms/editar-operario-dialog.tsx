  ...
  useEffect(() => {
    if (operario && open) {
      setForm({
        ...
        fecha_ingreso: operario.fecha_ingreso ? (operario.fecha_ingreso as string).substring(0, 10) : "",
        ...
        vencimiento_carnet: (operario as any).vencimiento_carnet ? ((operario as any).vencimiento_carnet as string).substring(0, 10) : "",
